...
void test_operation (const int num1, const int num2) {
    ...
    try {
        ...
        std::cout << "Error al crear los dígitos en decimal: " << e.what() << '\n';
    }
    catch (std::exception& e) {
        std::cout << e.what() << '\n';
    }
    ...
    try {
        ...
        std::cout << "Error al crear los dígitos en binario: " << e.what() << '\n';
    }
    catch (std::exception& e) {
        std::cout << e.what() << '\n';
    }
    ...
    if (std::is_same<T,char>::value) {
        try {
            ...
            std::cout << "Error al crear los dígitos en hexadecimal: " << e.what() << '\n';
        }
        catch (std::exception& e) {
            std::cout << e.what() << '\n';
        }
